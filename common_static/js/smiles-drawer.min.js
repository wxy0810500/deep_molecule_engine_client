(function g(d, e, t) {
    ...
    1: [function (e, t) {
            ...
            o && (window.SmilesDrawer = l),
            Array.prototype.fill || Object.defineProperty(Array.prototype, "fill", {
                value: function (e) {
                    if (null == this)
                        throw new TypeError("this is null or not defined");
                    for (var t = Object(this), r = t.length >>> 0, a = arguments[1], o = a >> 0, l = 0 > o ? i(r + o, 0) : n(o, r), s = arguments[2], g = void 0 === s ? r : s >> 0, d = 0 > g ? i(r + g, 0) : n(g, r); l < d; )
                        t[l] = e, l++;
                    return t
                }
            }),
    ...
    2: [function (e, t) {
            ...
            r = function () {
                function e(e, t) {
                    for (var n = 0, i; n < t.length; n++)
                        i = t[n], i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(e, i.key, i)
                }
            ...
            a = function () {
                ...
                return r(e, null, [{
                            ...
                            key: "merge",
                            value: function (e, t) {
                                for (var n = Array(e.length + t.length), r = 0; r < e.length; r++)
                                    n[r] = e[r];
                                for (var i = 0; i < t.length; i++)
                                    n[e.length + i] = t[i];
                                return n
                            ...
                            value: function (t) {
                                ...
                                return e.sort(function (e, t) {
                                    for (var n = Math.min(t.value.length, e.value.length), r = 0; r < n && t.value[r] === e.value[r]; )
                                        r++;
                            ...
                            key: "deepCopy",
                            value: function (t) {
                                for (var n = [], r = 0, i; r < t.length; r++)
                                    i = t[r], n[r] = i instanceof Array ? e.deepCopy(i) : i;
                                return n
                            }
                        }
                    ]),
                ...
                return i(e, [{
                            ...
                            value: function (e, t) {
                                for (var n = 0; n < e.ringbonds.length; n++)
                                    for (var i = 0; i < t.ringbonds.length; i++)
                                        if (e.ringbonds[n].id == t.ringbonds[i].id)
                                            return !0;
                                return !1
                            }
                        }, {
                            ...
                            value: function (e) {
                                ...
                                for (var t = 0; t < this.neighbouringElements.length; t++)
                                    if (e[t] !== this.neighbouringElements[t])
                                        return !1;
                                return !0
                            }
                        }, {
    ...
    4: [function (e, t) {
            ...
            d = function () {
                function e(t, i, r) {
                    n(this, e),
                    this.canvas = "string" == typeof t || t instanceof String ? document.getElementById(t) : t,
                ...
                return i(e, [{
                            ...
                            value: function (e, t) {
                                ...
                                1 === this.ratio ? (this.canvas.width = e * this.ratio, this.canvas.height = t * this.ratio) : (this.canvas.width = e * this.ratio, this.canvas.height = t * this.ratio, this.canvas.style.width = e + "px", this.canvas.style.height = t + "px", this.ctx.setTransform(this.ratio, 0, 0, this.ratio, 0, 0))
                            }
                        }, {
                            key: "setTheme",
                            value: function (e) {
                            ...
                            value: function (e) {
                                ...
                                this.offsetX = -a,
                                this.offsetY = -o,
                                g < d ? this.offsetY += this.canvas.offsetHeight / (2 * u) - this.drawingHeight / 2 : this.offsetX += this.canvas.offsetWidth / (2 * u) - this.drawingWidth / 2
                            }
                        }, {
                            key: "reset",
                            value: function () {
                            ...
                            value: function (e, t, n, i) {
                                ...
                                s.lineWidth = 1.5,
                                s.beginPath(),
                                s.arc(e + g, t + d, n, 0, a.twoPI, !0),
                                s.closePath(),
                                o ? (r ? (s.fillStyle = "#f00", s.fill()) : (s.strokeStyle = "#f00", s.stroke()), this.drawDebugText(e, t, l)) : r ? (s.fillStyle = i, s.fill()) : (s.strokeStyle = i, s.stroke()),
                                s.restore()
                            }
                        }, {
                            key: "drawLine",
                            value: function (e) {
                                ...
                                l.x += a,
                                l.y += o,
                                t || (i.save(), i.globalCompositeOperation = "destination-out", i.beginPath(), i.moveTo(g.x, g.y), i.lineTo(l.x, l.y), i.lineCap = "round", i.lineWidth = this.opts.bondThickness + 1.2, i.strokeStyle = this.getColor("BACKGROUND"), i.stroke(), i.globalCompositeOperation = "source-over", i.restore()),
                                g = e.getLeftVector().clone(),
                                ...
                                r.addColorStop(0.4, this.getColor(e.getLeftElement()) || this.getColor("C")),
                                r.addColorStop(0.6, this.getColor(e.getRightElement()) || this.getColor("C")),
                                t && (i.setLineDash([1, 1.5]), i.lineWidth = this.opts.bondThickness / 1.5),
                                1 > n && (i.globalAlpha = n),
                                i.strokeStyle = r,
                                i.stroke(),
                                i.restore()
                            ...
                            value: function (e) {
                                if (1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 1, !(isNaN(e.from.x) || isNaN(e.from.y) || isNaN(e.to.x) || isNaN(e.to.y))) {
                                    ...
                                    y.addColorStop(0.4, this.getColor(e.getLeftElement()) || this.getColor("C")),
                                    y.addColorStop(0.6, this.getColor(e.getRightElement()) || this.getColor("C")),
                                    n.fillStyle = y,
                                    n.fill(),
                                    n.restore()
                                }
                            ...
                            value: function (e) {
                                if (!(isNaN(e.from.x) || isNaN(e.from.y) || isNaN(e.to.x) || isNaN(e.to.y))) {
                                    ...
                                    c,
                                    p;
                                    g ? (u = l, h = s, d.shortenRight(1), c = d.getRightVector().clone(), p = d.getLeftVector().clone()) : (u = s, h = l, d.shortenLeft(1), c = d.getLeftVector().clone(), p = d.getRightVector().clone()),
                                    c.x += i,
                                    c.y += a,
                                    p.x += i,
                                    p.y += a;
                                    ...
                                    for (var y = e.getLength(), m = 1.25 / (y / (3 * this.opts.bondThickness)), f = !1, b = 0; 1 > b; b += m) {
                                        ...
                                        !f && 0.5 < b && (n.stroke(), n.beginPath(), n.strokeStyle = this.getColor(e.getRightElement()) || this.getColor("C"), f = !0),
                                        x.subtract(C),
                                        n.moveTo(x.x, x.y),
                                        x.add(o.multiplyScalar(C, 2)),
                                        n.lineTo(x.x, x.y)
                                    }
                                    n.stroke(),
                                    n.restore()
                            ...
                            value: function (e, t, n) {
                                ...
                                i.save(),
                                i.beginPath(),
                                i.arc(e + this.offsetX, t + this.offsetY, this.opts.bondLength / 4.5, 0, a.twoPI, !1),
                            ...
                            value: function (e, t, n) {
                                ...
                                i.beginPath(),
                                i.arc(e + r, t + o, 1.5, 0, a.twoPI, !0),
                                i.closePath(),
                                i.fill(),
                                i.globalCompositeOperation = "source-over",
                                i.beginPath(),
                                i.arc(e + this.offsetX, t + this.offsetY, 0.75, 0, a.twoPI, !1),
                                i.fillStyle = this.getColor(n),
                                i.fill(),
                                i.restore()
                            }
                            ...
                            value: function (e, t, n, i, o, l, s, g) {
                                ...
                                var y = "0",
                                m = 0;
                                0 < g && (y = g.toString(), u.font = this.fontSmall, m = u.measureText(y).width),
                                1 === s && "N" === n && d.hasOwnProperty("0O") && d.hasOwnProperty("0O-1") && (d = {
                                        "0O": {
                                            element: "O",
                                            count: 2,
                                            hydrogenCount: 0,
                                ...
                                u.fillText(n, e + h + r, t + this.opts.halfFontSizeLarge + c),
                                r += f.width,
                                s && (u.font = this.fontSmall, u.fillText(p, e + h + r, t - this.opts.fifthFontSizeSmall + c), r += v),
                                0 < g && (u.font = this.fontSmall, u.fillText(y, e + h + x - m, t - this.opts.fifthFontSizeSmall + c), x -= m),
                                u.font = this.fontLarge;
                                var k = 0,
                                C = 0;
                                if (1 === i) {
                                    ...
                                    k = this.hydrogenWidth,
                                    x -= k,
                                    "left" === o ? S += x : "right" === o ? S += r : "up" === o && l ? S += r : "down" === o && l ? S += r : "up" !== o || l ? "down" == o && !l && (R += this.opts.fontSizeLarge + this.opts.quarterFontSizeLarge, S -= this.halfHydrogenWidth) : (R -= this.opts.fontSizeLarge + this.opts.quarterFontSizeLarge, S -= this.halfHydrogenWidth),
                                    u.fillText("H", S, R),
                                    r += k
                                } else if (1 < i) {
                                    var A = e + h,
                                    ...
                                    x -= k + C,
                                    "left" === o ? A += x : "right" === o ? A += r : "up" === o && l ? A += r : "down" === o && l ? A += r : "up" !== o || l ? "down" == o && !l && (j += this.opts.fontSizeLarge + this.opts.quarterFontSizeLarge, A -= this.halfHydrogenWidth) : (j -= this.opts.fontSizeLarge + this.opts.quarterFontSizeLarge, A -= this.halfHydrogenWidth),
                                    u.font = this.fontLarge,
                                    u.fillText("H", A, j),
                                    u.font = this.fontSmall,
                                    u.fillText(i, A + this.halfHydrogenWidth + C, j + this.opts.fifthFontSizeSmall),
                                    r += k + this.halfHydrogenWidth + C
                                }
                                for (var T in d)
                                    if (d.hasOwnProperty(T)) {
                                        ...
                                        E = d[T].charge;
                                        u.font = this.fontLarge,
                                        1 < B && 0 < L && (w = u.measureText("(").width, I = u.measureText(")").width);
                                        var D = u.measureText(P).width,
                                        N = 0,
                                        O = "",
                                        V = 0;
                                        k = 0,
                                        0 < L && (k = this.hydrogenWidth),
                                        u.font = this.fontSmall,
                                        1 < B && (N = u.measureText(B).width),
                                        0 !== E && (O = this.getChargeText(E), V = u.measureText(O).width),
                                        C = 0,
                                        1 < L && (C = u.measureText(L).width),
                                        u.font = this.fontLarge;
                                        var H = e + h,
                                        z = t + c + this.opts.halfFontSizeLarge;
                                        u.fillStyle = this.getColor(P),
                                        0 < B && (x -= N),
                                        1 < B && 0 < L && ("left" === o ? (x -= I, u.fillText(")", H + x, z)) : (u.fillText("(", H + r, z), r += w)),
                                        "left" === o ? (x -= D, u.fillText(P, H + x, z)) : (u.fillText(P, H + r, z), r += D),
                                        0 < L && ("left" === o ? (x -= k + C, u.fillText("H", H + x, z), 1 < L && (u.font = this.fontSmall, u.fillText(L, H + x + k, z + this.opts.fifthFontSizeSmall))) : (u.fillText("H", H + r, z), r += k, 1 < L && (u.font = this.fontSmall, u.fillText(L, H + r, z + this.opts.fifthFontSizeSmall), r += C))),
                                        u.font = this.fontLarge,
                                        1 < B && 0 < L && ("left" === o ? (x -= w, u.fillText("(", H + x, z)) : (u.fillText(")", H + r, z), r += I)),
                                        u.font = this.fontSmall,
                                        1 < B && ("left" === o ? u.fillText(B, H + x + w + I + k + C + D, z + this.opts.fifthFontSizeSmall) : (u.fillText(B, H + r, z + this.opts.fifthFontSizeSmall), r += N)),
                                        0 !== E && ("left" === o ? u.fillText(O, H + x + w + I + k + C + D, t - this.opts.fifthFontSizeSmall + c) : (u.fillText(O, H + r, t - this.opts.fifthFontSizeSmall + c), r += V))
                                    }
                                u.restore()
                            }
                        }, {
                            ...
                            value: function (e) {
                                ...
                                t.beginPath(),
                                t.arc(e.center.x + this.offsetX, e.center.y + this.offsetY, n - this.opts.bondSpacing, 0, 2 * Math.PI, !0),
                                t.closePath(),
                                t.stroke(),
                                t.restore()
                            }
                ...
                return a(e, [{
                                ...
                                for (var a = function (i) {
                                    for (var r in i)
                                        Object.prototype.hasOwnProperty.call(i, r)
                                             && (t[r] = n && "[object Object]" === Object.prototype.toString.call(i[r]) ? e.extend(!0, t[r], i[r]) : i[r])
                            ...
                            value: function (e, t) {
                                ...
                                if (this.data = e, this.infoOnly = r, this.infoOnly || (this.canvasWrapper = new y(t, this.opts.themes[n], this.opts)), this.ringIdCounter = 0, this.ringConnectionIdCounter = 0, this.graph = new m(e, this.opts.isomeric), this.rings = [], this.ringConnections = [], this.originalRings = [], this.originalRingConnections = [], this.bridgedRing = !1, this.doubleBondConfigCount = null, this.doubleBondConfig = null, this.initRings(), this.initHydrogens(), !this.infoOnly) {
                                            ...
                                            if (i = this.graph.edges[o], this.isEdgeRotatable(i)) {
                                                ...
                                                if (c.value > this.opts.overlapSensitivity) {
                                                    ...
                                                    if (1 === f.length) {
                                                        ...
                                                        if (0 !== v.value.rings.length && 0 !== p.value.rings.length)
                                                            continue;
                                                        var C = this.graph.vertices[f[0]],
                                                        S = this.graph.vertices[f[1]];
                                                        if (1 === C.value.rings.length && 1 === S.value.rings.length) {
                                                            if (C.value.rings[0] !== S.value.rings[0])
                                                                continue;
                                                        } else if (0 !== C.value.rings.length || 0 !== S.value.rings.length)
                                                            continue;
                                                        else {
                                                            ...
                                                            this.rotateSubtree(C.id, v.id, R, v.position),
                                                            this.rotateSubtree(S.id, v.id, A, v.position);
                                    ...
                                    this.opts.compactDrawing && "default" === this.opts.atomVisualization && this.initPseudoElements(),
                                    this.rotateDrawing(),
                            ...
                            value: function () {
                                for (var e = "", t = 0, n; t < this.rings.length; t++)
                                    n = this.rings[t], e += n.id + ";", e += n.members.length + ";", e += n.neighbours.length + ";", e += n.isSpiro ? "true;" : "false;", e += n.isFused ? "true;" : "false;", e += n.isBridged ? "true;" : "false;", e += n.rings.length + ";", e += "\n";
                                return e
                            }
                        }, {
                            key: "rotateDrawing",
                            value: function () {
                                ...
                                if (!isNaN(g)) {
                                    ...
                                    for (var r = 0; r < this.graph.vertices.length; r++)
                                        r !== t && this.graph.vertices[r].position.rotateAround(g, this.graph.vertices[t].position);
                                    for (var r = 0; r < this.rings.length; r++)
                                        this.rings[r].center.rotateAround(g, this.graph.vertices[t].position)
                                }
                            }
                        }, {
                            ...
                            value: function () {
                                for (var t = "", n = new Map, e = 0, i; e < this.graph.vertices.length; e++)
                                    if (i = this.graph.vertices[e].value, n.has(i.element) ? n.set(i.element, n.get(i.element) + 1) : n.set(i.element, 1), i.bracket && !i.bracket.chirality && (n.has("H") ? n.set("H", n.get("H") + i.bracket.hcount) : n.set("H", i.bracket.hcount)), !i.bracket) {
                                        ...
                                        i.isPartOfAromaticRing && r--,
                                        n.has("H") ? n.set("H", n.get("H") + r) : n.set("H", r)
                                    }
                                if (n.has("C")) {
                                    var a = n.get("C");
                                    t += "C" + (1 < a ? a : ""),
                            ...
                            key: "getRingbondType",
                            value: function (e, t) {
                                if (1 > e.value.getRingbondCount() || 1 > t.value.getRingbondCount())
                                    return null;
                                for (var n = 0; n < e.value.ringbonds.length; n++)
                                    for (var i = 0; i < t.value.ringbonds.length; i++)
                                        if (e.value.ringbonds[n].id === t.value.ringbonds[i].id)
                                            return "-" === e.value.ringbonds[n].bondType ? t.value.ringbonds[i].bond : e.value.ringbonds[n].bond;
                                return null
                            }
                        }, {
                            key: "initRings",
                            value: function () {
                                    ...
                                    if (i = this.graph.vertices[t], 0 !== i.value.ringbonds.length)
                                        for (var r = 0; r < i.value.ringbonds.length; r++) {
                                            ...
                                            if (!e.has(o))
                                                ...
                                                i.addRingbondChild(g, r),
                                                i.value.addNeighbouringElement(y.value.element),
                                                y.addRingbondChild(s, r),
                                                y.value.addNeighbouringElement(i.value.element),
                                                i.edges.push(c),
                                                y.edges.push(c),
                                                e.delete(o)
                                            }
                                ...
                                if (null !== m) {
                                    for (var t = 0; t < m.length; t++)
                                        for (var x = [].concat(n(m[t])), k = this.addRing(new p(x)), r = 0; r < x.length; r++)
                                            this.graph.vertices[x[r]].value.rings.push(k);
                                    ...
                                    for (var t = 0, S; t < this.rings.length; t++)
                                        S = this.rings[t], S.neighbours = v.getNeighbours(this.ringConnections, S.id);
                                    for (var t = 0, R; t < this.rings.length; t++)
                                        R = this.rings[t], this.graph.vertices[R.members[0]].value.addAnchoredRing(R.id);
                                    for (this.backupRingInformation(); 0 < this.rings.length; ) {
                                        for (var A = -1, t = 0, j; t < this.rings.length; t++)
                                            j = this.rings[t], this.isPartOfBridgedRing(j.id) && !j.isBridged && (A = j.id);
                                        if (-1 === A)
                                            break;
                                        var T = this.getRing(A),
                                        w = this.getBridgedRingRings(T.id);
                                        this.bridgedRing = !0,
                                        this.createBridgedRing(w, T.members[0]);
                                ...
                                if (!this.opts.explicitHydrogens)
                                    for (var e = 0, t; e < this.graph.vertices.length; e++)
                                        if (t = this.graph.vertices[e], "H" === t.value.element) {
                                            ...
                                            (!n.value.isStereoCenter || 2 > n.value.rings.length && !n.value.bridgedRing || n.value.bridgedRing && 2 > n.value.originalRings.length) && (t.value.isDrawn = !1)
                                        }
                            }
                        }, {
                            ...
                            value: function (e) {
                                ...
                                return function e(o) {
                                    ...
                                    for (var l = 0, i; l < r.neighbours.length; l++)
                                        i = r.neighbours[l], -1 === t.indexOf(i) && i !== o && v.isBridge(a.ringConnections, a.graph.vertices, o, i) && e(i)
                                }
                                (e),
                                d.unique(t)
                            }
                            ...
                            value: function (e) {
                                for (var t = 0; t < this.ringConnections.length; t++)
                                    if (this.ringConnections[t].containsRing(e) && this.ringConnections[t].isBridge(this.graph.vertices))
                                        return !0;
                                return !1
                            }
                        }, {
                            ...
                            value: function (e) {
                                for (var t = new Set, r = new Set, a = new Set, o = 0, i; o < e.length; o++) {
                                    ...
                                    for (var l = 0, s; l < i.neighbours.length; l++)
                                        s = i.neighbours[l], -1 === e.indexOf(s) && a.add(i.neighbours[l])
                                }
                                var g = new Set,
                                u = !0,
                                h = !1,
                                ...
                                try {
                                    for (var R = g[Symbol.iterator](), A; !(k = (A = R.next()).done); k = !0) {
                                        for (var j = A.value, T = this.graph.vertices[j], w = !1, I = 0; I < T.edges.length; I++)
                                            1 === this.edgeRingCount(T.edges[I]) && (w = !0);
                                ...
                                P.isBridged = !0,
                                P.neighbours = [].concat(n(a));
                                for (var o = 0; o < e.length; o++)
                                    P.rings.push(this.getRing(e[o]).clone());
                                this.addRing(P);
                                for (var o = 0; o < P.members.length; o++)
                                    this.graph.vertices[P.members[o]].value.bridgedRing = P.id;
                                for (var o = 0, B; o < x.length; o++)
                                    B = this.graph.vertices[x[o]], B.value.rings = [];
                                var L = !0,
                                E = !1,
                                D;
                                try {
                                    for (var N = t[Symbol.iterator](), O; !(L = (O = N.next()).done); L = !0) {
                                        ...
                                        H.value.rings = d.removeAll(H.value.rings, e),
                                        H.value.rings.push(P.id)
                                    }
                                } catch (e) {
                                    E = !0,
                                    D = e
                                ...
                                try {
                                    for (var _ = a[Symbol.iterator](), M; !(z = (M = _.next()).done); z = !0) {
                                        for (var q = M.value, U = this.getRingConnections(q, e), l = 0; l < U.length; l++)
                                            this.getRingConnection(U[l]).updateOther(P.id, q);
                            ...
                            value: function (e, t) {
                                for (var n = 0; n < e.value.rings.length; n++)
                                    for (var i = 0; i < t.value.rings.length; i++)
                                        if (e.value.rings[n] === t.value.rings[i])
                                            return !0;
                                return !1
                            }
                        }, {
                            ...
                            value: function (e, t) {
                                for (var n = this.getCommonRings(e, t), r = 0, a = null, o = 0; o < n.length; o++) {
                                    ...
                                    l = i.getSize();
                                    if (i.isBenzeneLike(this.graph.vertices))
                                        return i;
                                    l > r && (r = l, a = i)
                                }
                                return a
                            ...
                            key: "addRing",
                            value: function (e) {
                                return e.id = this.ringIdCounter++,
                                this.rings.push(e),
                                e.id
                            }
                        }, {
                            ...
                            value: function (e) {
                                ...
                                for (var t = 0, n; t < this.rings.length; t++)
                                    n = this.rings[t], n.neighbours = n.neighbours.filter(function (t) {
                                        return t !== e
                                    })
                            }
                        }, {
                            ...
                            value: function (e) {
                                for (var t = 0; t < this.rings.length; t++)
                                    if (this.rings[t].id == e)
                                        return this.rings[t]
                            }
                        }, {
                            key: "addRingConnection",
                            value: function (e) {
                                return e.id = this.ringConnectionIdCounter++,
                            ...
                            value: function (e, t) {
                                for (var n = [], r = 0, i; r < this.ringConnections.length; r++)
                                    i = this.ringConnections[r], (i.firstRingId === e && i.secondRingId === t || i.firstRingId === t && i.secondRingId === e) && n.push(i.id);
                                for (var r = 0; r < n.length; r++)
                                    this.removeRingConnection(n[r])
                            }
                        }, {
                            ...
                            value: function (e, t) {
                                for (var n = [], r = 0, i; r < this.ringConnections.length; r++) {
                                    ...
                                    for (var a = 0, o; a < t.length; a++)
                                        o = t[a], (i.firstRingId === e && i.secondRingId === o || i.firstRingId === o && i.secondRingId === e) && n.push(i.id)
                                }
                                return n
                            }
                        }, {
                            key: "getOverlapScore",
                            value: function () {
                                for (var e = 0, t = new Float32Array(this.graph.vertices.length), n = 0; n < this.graph.vertices.length; n++)
                                    t[n] = 0;
                            ...
                            key: "chooseSide",
                            value: function (e, t, n) {
                                for (var r = e.getNeighbours(t.id), a = t.getNeighbours(e.id), o = r.length, l = a.length, s = d.merge(r, a), g = [0, 0], u = 0, i; u < s.length; u++)
                                    i = this.graph.vertices[s[u]].position, i.sameSideAs(e.position, t.position, n[0]) ? g[0]++ : g[1]++;
                                for (var h = [0, 0], u = 0, c; u < this.graph.vertices.length; u++)
                                    c = this.graph.vertices[u].position, c.sameSideAs(e.position, t.position, n[0]) ? h[0]++ : h[1]++;
                                return {
                                    totalSideCount: h,
                            ...
                            key: "setRingCenter",
                            value: function (e) {
                                for (var t = e.getSize(), n = new l(0, 0), r = 0; r < t; r++)
                            ...
                            value: function (e, t) {
                                for (var n = t.value.originalRings, r = e.center, a = Number.MAX_VALUE, o = 0; o < n.length; o++)
                                    for (var i = 0; i < e.rings.length; i++)
                                        n[o] === e.rings[i].id && e.rings[i].getSize() < a && (r = e.rings[i].center, a = e.rings[i].getSize());
                                return r
                            }
                        }, {
                            key: "drawEdges",
                            value: function (e) {
                                ...
                                if (n.fill(!1), this.graph.traverseBF(0, function (r) {
                                        for (var a = t.graph.getEdges(r.id), o = 0, i; o < a.length; o++)
                                            i = a[o], n[i] || (n[i] = !0, t.drawEdge(i, e))
                                        }), !this.bridgedRing)for (var r = 0, i; r < this.rings.length; r++)
                                        i = this.rings[r], this.isRingAromatic(i) && this.canvasWrapper.drawAromaticityRing(i)
                            }
                        }, {
                            key: "drawEdge",
                            value: function (e, t) {
                                ...
                                if (r.value.isDrawn && o.value.isDrawn || "default" !== this.opts.atomVisualization) {
                                    ...
                                    if (p[0].multiplyScalar(10).add(h), p[1].multiplyScalar(10).add(h), "=" === i.bondType || "=" === this.getRingbondType(r, o) || i.isPartOfAromaticRing && this.bridgedRing) {
                                        ...
                                        if (v) {
                                            ...
                                            f = m.center;
                                            c[0].multiplyScalar(n.opts.bondSpacing),
                                            c[1].multiplyScalar(n.opts.bondSpacing);
                                            var b = null;
                                            b = f.sameSideAs(r.position, o.position, l.add(h, c[0])) ? new s(l.add(h, c[0]), l.add(a, c[0]), g, u) : new s(l.add(h, c[1]), l.add(a, c[1]), g, u),
                                            b.shorten(this.opts.bondLength - this.opts.shortBondLength * this.opts.bondLength),
                                            i.isPartOfAromaticRing ? this.canvasWrapper.drawLine(b, !0) : this.canvasWrapper.drawLine(b),
                                            this.canvasWrapper.drawLine(new s(h, a, g, u))
                                        } else if (i.center || r.isTerminal() && o.isTerminal()) {
                                            c[0].multiplyScalar(n.opts.halfBondSpacing),
                                            c[1].multiplyScalar(n.opts.halfBondSpacing);
                                            ...
                                            R.shorten(this.opts.bondLength - this.opts.shortBondLength * this.opts.bondLength),
                                            ...
                                            A.shorten(this.opts.bondLength - this.opts.shortBondLength * this.opts.bondLength),
                                            ...
                                            j.shorten(this.opts.bondLength - this.opts.shortBondLength * this.opts.bondLength),
                                        ...
                                        c[0].multiplyScalar(n.opts.bondSpacing / 1.5),
                                        c[1].multiplyScalar(n.opts.bondSpacing / 1.5);
                                        var w = new s(l.add(h, c[0]), l.add(a, c[0]), g, u),
                                        I = new s(l.add(h, c[1]), l.add(a, c[1]), g, u);
                                        this.canvasWrapper.drawLine(w),
                                        this.canvasWrapper.drawLine(I),
                                        this.canvasWrapper.drawLine(new s(h, a, g, u))
                                    } else if ("." === i.bondType);
                                    else {
                            ...
                            value: function (e) {
                                for (var t = this.graph.vertices.length, t = 0; t < this.graph.vertices.length; t++) {
                                    ...
                                    y = "C" === i.element;
                                    if ("N" === i.element && i.isPartOfAromaticRing && (h = 0), i.bracket && (h = i.bracket.hcount, o = i.bracket.charge, s = i.bracket.isotope), "allballs" === this.opts.atomVisualization)
                                        this.canvasWrapper.drawBall(n.position.x, n.position.y, u);
                                    else if (i.isDrawn && (!y || i.drawExplicit || v || i.hasAttachedPseudoElements) || 1 === this.graph.vertices.length)
                                        "default" === this.opts.atomVisualization ? this.canvasWrapper.drawText(n.position.x, n.position.y, u, h, p, v, o, s, i.getAttachedPseudoElements()) : "balls" === this.opts.atomVisualization && this.canvasWrapper.drawBall(n.position.x, n.position.y, u);
                                ...
                                if (this.opts.debug)
                                    for (var t = 0, x; t < this.rings.length; t++)
                                        x = this.rings[t].center, this.canvasWrapper.drawDebugPoint(x.x, x.y, "r: " + this.rings[t].id)
                            }
                        }, {
                            key: "position",
                            value: function () {
                                ...
                                for (var t = 0; t < this.rings.length; t++)
                                    this.rings[t].isBridged && (e = this.graph.vertices[this.rings[t].members[0]]);
                                0 < this.rings.length && null === e && (e = this.graph.vertices[this.rings[0].members[0]]),
                            ...
                            value: function () {
                                ...
                                for (var t = 0, n; t < e.length; t++) {
                                    n = e[t];
                                    for (var i = 0, r; i < n.rings.length; i++)
                                        r = n.rings[i], this.originalRings[r.id].center = r.center
                                }
                                for (var t = 0; t < this.originalRings.length; t++)
                                    this.rings.push(this.originalRings[t]);
                                for (var t = 0; t < this.originalRingConnections.length; t++)
                                    this.ringConnections.push(this.originalRingConnections[t]);
                            ...
                            value: function (e) {
                                ...
                                if (!e.positioned) {
                                    ...
                                    if (-1 === e.members.indexOf(p) && (n && (n.positioned = !1), p = e.members[0]), e.isBridged) {
                                        this.graph.kkLayout(e.members.slice(), t, n.id, e, this.opts.bondLength),
                                        e.positioned = !0,
                                        this.setRingCenter(e),
                                        t = e.center;
                                        for (var y = 0; y < e.rings.length; y++)
                                            this.setRingCenter(e.rings[y])
                                    } else
                                        e.eachMember(this.graph.vertices, function (n) {
                                            var i = a.graph.vertices[n];
                                            i.positioned || i.setPosition(t.x + Math.cos(c) * u, t.y + Math.sin(c) * u),
                                            c += h,
                                            (!e.isBridged || 3 > e.rings.length) && (i.angle = c, i.positioned = !0)
                                        }, p, o ? o.id : null);
                                    e.positioned = !0,
                                    e.center = t;
                                    for (var y = 0, i; y < s.length; y++)
                                        if (i = this.getRing(s[y].neighbour), !i.positioned) {
                                            ...
                                            if (2 === m.length) {
                                                ...
                                                k[0].multiplyScalar(r).add(x),
                                                k[1].multiplyScalar(r).add(x);
                                                var S = k[0];
                                                l.subtract(t, k[1]).lengthSq() > l.subtract(t, k[0]).lengthSq() && (S = k[1]);
                                                var R = l.subtract(f.position, S),
                                                A = l.subtract(b.position, S);
                                                -1 === R.clockwise(A) ? !i.positioned && this.createRing(i, S, f, b) : !i.positioned && this.createRing(i, S, b, f)
                                            } else if (1 === m.length) {
                                                e.isSpiro = !0,
                                                i.isSpiro = !0;
                                                ...
                                                w.multiplyScalar(I),
                                                w.add(T.position),
                                                i.positioned || this.createRing(i, w, T)
                                            }
                                        }
                                    for (var y = 0; y < e.members.length; y++)
                                        for (var P = this.graph.vertices[e.members[y]], B = P.neighbours, L = 0, j; L < B.length; L++)
                                            (j = this.graph.vertices[B[L]], !j.positioned) && (j.value.isConnectedToRing = !0, this.createNextBond(j, P, 0))
                                }
                            }
                        }, {
                            key: "rotateSubtree",
                            value: function (e, t, n, r) {
                                ...
                                this.graph.traverseTree(e, t, function (e) {
                                    ...
                                    for (var t = 0, i; t < e.value.anchoredRings.length; t++)
                                        i = a.rings[e.value.anchoredRings[t]], i && i.center.rotateAround(n, r)
                                })
                            }
                        }, {
                            ...
                            value: function () {
                                for (var e = new l(0, 0), t = 0, n = 0, i; n < this.graph.vertices.length; n++)
                                    i = this.graph.vertices[n], i.positioned && (e.add(i.position), t++);
                                return e.divide(t)
                            }
                        }, {
                            key: "getCurrentCenterOfMassInNeigbourhood",
                            value: function (e) {
                                for (var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 2 * this.opts.bondLength, n = new l(0, 0), r = 0, a = 0, i; a < this.graph.vertices.length; a++)
                                    i = this.graph.vertices[a], i.positioned && e.distanceSq(i.position) < t * t && (n.add(i.position), r++);
                                return n.divide(r)
                            }
                        }, {
                            ...
                            value: function () {
                                for (var e = [], t = Array(this.graph.vertices.length), n = 0, i; n < this.rings.length; n++) {
                                    ...
                                    for (var o = 0, l; o < i.members.length; o++)
                                        if (l = this.graph.vertices[i.members[o]], !t[l.id]) {
                                            ...
                                            if (1 < s.length) {
                                                for (var g = [], d = 0; d < l.value.rings.length; d++)
                                                    g.push(l.value.rings[d]);
                                                e.push({
                                                    common: l,
                                                    rings: g,
                                                    vertices: s
                                                ...
                                                for (var u = [], d = 0; d < l.value.rings.length; d++)
                                                    u.push(l.value.rings[d]);
                                                e.push({
                                                    common: l,
                                                    rings: u,
                                                    vertices: s
                                ...
                                for (var n = 0, h; n < e.length; n++)
                                    if (h = e[n], 2 === h.vertices.length) {
                                        var c = h.vertices[0],
                                        a = h.vertices[1];
                                        if (!c.value.isDrawn || !a.value.isDrawn)
                                            continue;
                                        var p = (2 * r - this.getRing(h.rings[0]).getAngle()) / 6;
                                        this.rotateSubtree(c.id, h.common.id, p, h.common.position),
                                        this.rotateSubtree(a.id, h.common.id, -p, h.common.position);
                                        ...
                                        f = y.value + m.value;
                                        this.rotateSubtree(c.id, h.common.id, -2 * p, h.common.position),
                                        this.rotateSubtree(a.id, h.common.id, 2 * p, h.common.position),
                                        v = this.getOverlapScore(),
                                        y = this.getSubtreeOverlapScore(c.id, h.common.id, v.vertexScores),
                                        m = this.getSubtreeOverlapScore(a.id, h.common.id, v.vertexScores),
                                        y.value + m.value > f && (this.rotateSubtree(c.id, h.common.id, 2 * p, h.common.position), this.rotateSubtree(a.id, h.common.id, -2 * p, h.common.position))
                                    } else
                                        1 !== h.vertices.length || 2 !== h.rings.length
                            }
                        }, {
                            ...
                            value: function (e) {
                                for (var t = 0, n = null; !t && e; )
                                    n = this.graph.vertices[e], t = n.angle, e = n.parentVertexId;
                                return n
                            }
                        }, {
                            key: "createNextBond",
                                ...
                                if (!e.positioned || h) {
                                    ...
                                    if (!h)
                                        if (!t) {
                                            ...
                                            if (null === b) {
                                                for (var C = 0, S; C < f.length; C++)
                                                    S = this.graph.vertices[f[C]], S.positioned && this.areVerticesInSameRing(S, t) && k.add(l.subtract(S.position, t.position));
                                                k.invert().normalize().multiplyScalar(this.opts.bondLength).add(t.position)
                                            } else
                                                k = b.position.clone().rotateAround(Math.PI, t.position);
                                    ...
                                    if (null !== e.value.bridgedRing) {
                                        ...
                                        for (var P = e.value.isStereoCenter, B = e.getNeighbours(), L = [], C = 0; C < B.length; C++)
                                            this.graph.vertices[B[C]].value.isDrawn && L.push(B[C]);
                                        t && (L = d.remove(L, t.id));
                                        var E = e.getAngle();
                                        if (1 === L.length) {
                                            ...
                                            if ("#" === e.value.bondType || t && "#" === t.value.bondType || "=" === e.value.bondType && t && 0 === t.value.rings.length && "=" === t.value.bondType && "-" !== e.value.branchBond) {
                                                ...
                                                O.center = !0,
                                                ("#" === e.value.bondType || t && "#" === t.value.bondType) && (D.angle = 0),
                                                D.drawExplicit = !0,
                                                ...
                                                if (t && 3 < t.neighbours.length)
                                                    U = 0 < U ? o(1.0472, U) : 0 > U ? Math.max(-1.0472, U) : 1.0472;
                                                else if (!U) {
                                            ...
                                            ie.angle = Y,
                                            ne.angle = -Y,
                                            "\\" === this.doubleBondConfig ? "\\" === ie.value.branchBond && (ie.angle = -Y, ne.angle = Y) : "/" === this.doubleBondConfig && "/" === ie.value.branchBond && (ie.angle = -Y, ne.angle = Y),
                                            ...
                                            ye.value.subtreeDepth = he,
                                            w.value.subtreeDepth = ce,
                                            x.value.subtreeDepth = pe,
                                            y.value.subtreeDepth = ve,
                                            ce > he && ce > pe && ce > ve ? (ye = this.graph.vertices[L[1]], w = this.graph.vertices[L[0]], x = this.graph.vertices[L[2]], y = this.graph.vertices[L[3]]) : pe > he && pe > ce && pe > ve ? (ye = this.graph.vertices[L[2]], w = this.graph.vertices[L[0]], x = this.graph.vertices[L[1]], y = this.graph.vertices[L[3]]) : ve > he && ve > ce && ve > pe && (ye = this.graph.vertices[L[3]], w = this.graph.vertices[L[0]], x = this.graph.vertices[L[1]], y = this.graph.vertices[L[2]]),
                                            ye.angle = -g.toRad(36),
                                            w.angle = g.toRad(36),
                                            x.angle = -g.toRad(108),
                                            y.angle = g.toRad(108),
                                            this.createNextBond(ye, e, E + ye.angle),
                            ...
                            value: function (e) {
                                for (var t = e.neighbours, n = 0, i; n < t.length; n++)
                                    if (i = this.graph.vertices[t[n]], d.containsAll(i.value.rings, e.value.rings))
                                        return i;
                                return null
                            }
                        }, {
                            ...
                            value: function (e) {
                                for (var t = 0, n; t < e.members.length; t++)
                                    if (n = this.graph.vertices[e.members[t]], !n.value.isPartOfAromaticRing)
                                        return !1;
                                return !0
                            }
                        }, {
                                ...
                                for (var e = 0, t; e < this.graph.vertices.length; e++)
                                    if (t = this.graph.vertices[e], !!t.value.isStereoCenter) {
                                        for (var n = t.getNeighbours(), i = n.length, r = Array(i), a = 0; a < i; a++) {
                                            ...
                                            s = [[]];
                                            o[t.id] = 1,
                                            this.visitStereochemistry(n[a], t.id, o, s, 10, 0);
                                        ...
                                        for (var u = 0, h = 0, a = 0; a < r.length; a++) {
                                            ...
                                            for (var d = 0; d < r[a][1].length; d++)
                                                r[a][1][d].length > h && (h = r[a][1][d].length)
                                        }
                                        ...
                                        for (var l = new Uint8Array(i), a = 0; a < i; a++)
                                            l[a] = r[a][0], t.value.priority = a;
                                        ...
                                        R = "down",
                                        A = "up";
                                        (k && "R" != S || !k && "S" != S) && (t.value.hydrogenDirection = "up", R = "up", A = "down"),
                                        t.value.hasHydrogen && (this.graph.getEdge(t.id, n[l[l.length - 1]]).wedge = R);
                                        for (var j = Array(n.length - 1), T = 1 < t.value.rings.length && t.value.hasHydrogen, w = t.value.hasHydrogen ? 1 : 0, a = 0; a < l.length - w; a++) {
                                            ...
                                            j[a][0] += I.value.isStereoCenter ? 0 : 1e5,
                                            j[a][0] += this.areVerticesInSameRing(I, t) ? 0 : 1e4,
                                            j[a][0] += I.value.isHeteroAtom() ? 1e3 : 0,
                                            j[a][0] -= 0 === I.value.subtreeDepth ? 1e3 : 0,
                                            j[a][0] += 1e3 - I.value.subtreeDepth,
                                            j[a][1] = n[l[a]]
                                        }
                                        if (j.sort(function (e, t) {
                                            ...
                                            if (t.value.hasHydrogen)
                                                this.graph.getEdge(t.id, P).wedge = A;
                                            else {
                            ...
                            value: function (e, t, n, r, a, o) {
                                ...
                                r.length <= o && r.push([]);
                                for (var d = 0; d < this.graph.getEdge(e, t).weight; d++)
                                    r[o].push(1e3 * l + g);
                                for (var i = this.graph.vertices[e].neighbours, d = 0; d < i.length; d++)
                                    1 !== n[i[d]] && o < a - 1 && this.visitStereochemistry(i[d], e, n.slice(), r, a, o + 1, g);
                                if (o < a - 1) {
                                    for (var u = 0, d = 0; d < i.length; d++)
                                        u += this.graph.getEdge(e, i[d]).weight;
                                    for (var d = 0; d < s.value.getMaxBonds() - u; d++)
                                        r.length <= o + 1 && r.push([]), r[o + 1].push(1e3 * g + 1)
                                }
                            }
                        }, {
                            ...
                            value: function () {
                                for (var e = 0; e < this.graph.vertices.length; e++) {
                                    for (var t = this.graph.vertices[e], n = t.neighbours, i = Array(n.length), r = 0; r < n.length; r++)
                                        i[r] = this.graph.vertices[n[r]];
                                    if (!(3 > t.getNeighbourCount() || 0 < t.value.rings.length) && "P" !== t.value.element && ("C" !== t.value.element || 3 !== i.length || "N" !== i[0].value.element || "N" !== i[1].value.element || "N" !== i[2].value.element)) {
                                        ...
                                        if (!(1 < o || 2 > a)) {
                                            for (var d = null, r = 0, u; r < i.length; r++)
                                                u = i[r], 1 < u.getNeighbourCount() && (d = u);
                                            for (var r = 0, h; r < i.length; r++)
                                                if (h = i[r], !(1 < h.getNeighbourCount())) {
                                                    h.value.isDrawn = !1;
                                                    var p = c.maxBonds[h.value.element] - h.value.bondCount,
                                                    v = "";
                                                    h.value.bracket && (p = h.value.bracket.hcount, v = h.value.bracket.charge || 0),
                                                    t.value.attachPseudoElement(h.value.element, d ? d.value.element : null, p, v)
                                                }
                                        }
                                    }
                                }
                                for (var e = 0; e < this.graph.vertices.length; e++) {
                                    ...
                                    if ("C" !== f && "H" !== f && m.isDrawn) {
                                        for (var b = y.neighbours, x = Array(b.length), r = 0; r < b.length; r++)
                                            x[r] = this.graph.vertices[b[r]];
                ...
                return i(e, [{
                            ...
                            value: function (e) {
                                ...
                                if (this.addVertex(o), null !== n) {
                                    ...
                                    l.addChild(o.id),
                                    l.value.addNeighbouringElement(a.element),
                                    l.spanningTreeChildren.push(o.id);
                                    var s = new u(n, o.id, 1),
                                    g = null;
                                    r ? (s.setBondType(o.value.branchBond || "-"), g = o.id, s.setBondType(o.value.branchBond || "-"), g = o.id) : (s.setBondType(l.value.bondType || "-"), g = l.id),
                                    this.addEdge(s)
                                }
                                ...
                                for (var v = 0; v < e.branchCount; v++)
                                    this._init(e.branches[v], v + h, o.id, !0);
                            ...
                            key: "addVertex",
                            value: function (e) {
                                return e.id = this.vertices.length,
                            ...
                            value: function (e) {
                                ...
                                return e.id = this.edges.length,
                                this.edges.push(e),
                                this.vertexIdsToEdgeId[e.sourceId + "_" + e.targetId] = e.id,
                                this.vertexIdsToEdgeId[e.targetId + "_" + e.sourceId] = e.id,
                                e.isPartOfAromaticRing = t.value.isPartOfAromaticRing && n.value.isPartOfAromaticRing,
                            ...
                            key: "getEdges",
                            value: function (e) {
                                for (var t = [], n = this.vertices[e], r = 0; r < n.neighbours.length; r++)
                            ...
                            key: "getVertexList",
                            value: function () {
                                for (var e = [this.vertices.length], t = 0; t < this.vertices.length; t++)
                            ...
                            key: "getEdgeList",
                            value: function () {
                                for (var e = Array(this.edges.length), t = 0; t < this.edges.length; t++)
                            ...
                            value: function () {
                                ...
                                for (var n = 0, i; n < this.edges.length; n++)
                                    i = this.edges[n], t[i.sourceId][i.targetId] = 1, t[i.targetId][i.sourceId] = 1;
                                return t
                            }
                        }, {
                            key: "getComponentsAdjacencyMatrix",
                            value: function () {
                                for (var e = this.vertices.length, t = Array(e), n = this.getBridges(), r = 0; r < e; r++)
                                    t[r] = Array(e), t[r].fill(0);
                                for (var r = 0, i; r < this.edges.length; r++)
                                    i = this.edges[r], t[i.sourceId][i.targetId] = 1, t[i.targetId][i.sourceId] = 1;
                                for (var r = 0; r < n.length; r++)
                                    t[n[r][0]][n[r][1]] = 0, t[n[r][1]][n[r][0]] = 0;
                                return t
                            }
                        }, {
                            ...
                            value: function () {
                                for (var e = this.vertices.length, t = this.getAdjacencyMatrix(), n = Array(e), r = 0; r < e; r++)
                                    n[r] = Array(e), n[r].fill(Infinity);
                                for (var r = 0; r < e; r++)
                                    for (var i = 0; i < e; i++)
                                        1 === t[r][i] && (n[r][i] = 1);
                                for (var a = 0; a < e; a++)
                                    for (var r = 0; r < e; r++)
                                        for (var i = 0; i < e; i++)
                                            n[r][i] > n[r][a] + n[a][i] && (n[r][i] = n[r][a] + n[a][i]);
                                return n
                            }
                        }, {
                            key: "getSubgraphDistanceMatrix",
                            value: function (e) {
                                for (var t = e.length, n = this.getSubgraphAdjacencyMatrix(e), r = Array(t), a = 0; a < t; a++)
                                    r[a] = Array(t), r[a].fill(Infinity);
                                for (var a = 0; a < t; a++)
                                    for (var i = 0; i < t; i++)
                                        1 === n[a][i] && (r[a][i] = 1);
                                for (var o = 0; o < t; o++)
                                    for (var a = 0; a < t; a++)
                                        for (var i = 0; i < t; i++)
                                            r[a][i] > r[a][o] + r[o][i] && (r[a][i] = r[a][o] + r[o][i]);
                                return r
                            }
                        }, {
                            ...
                            value: function () {
                                for (var e = this.vertices.length, t = Array(e), n = 0; n < e; n++) {
                                    t[n] = [];
                                    for (var i = 0; i < e; i++)
                                        n !== i && this.hasEdge(this.vertices[n].id, this.vertices[i].id) && t[n].push(i)
                                }
                                return t
                            }
                        }, {
                            ...
                            value: function () {
                                ...
                                this._time = 0;
                                for (var s = 0; s < e; s++)
                                    t[s] || this._bridgeDfs(s, t, n, r, a, o, l);
                                return l
                            }
                        }, {
                            key: "traverseBF",
                            value: function (e, t) {
                                ...
                                for (var a = [e]; 0 < a.length; ) {
                                    ...
                                    for (var s = 0, i; s < l.neighbours.length; s++)
                                        i = l.neighbours[s], r[i] || (r[i] = !0, a.push(i))
                                }
                            }
                        }, {
                            key: "getTreeDepth",
                            ...
                            value: function (e, t, n) {
                                ...
                                if (null === l && (l = new Uint8Array(this.vertices.length)), !(o > r + 1 || 1 === l[e])) {
                                    ...
                                    for (var d = 0; d < g.length; d++)
                                        this.traverseTree(g[d], e, n, r, a, o + 1, l)
                                }
                            }
                        }, {
                            key: "kkLayout",
                            value: function (e, t, n, o, g) {
                                for (var d = g, u = e.length; u--; )
                                    var i = this.vertices[e[u]], h = i.neighbours.length;
                                ...
                                for (u = p; u--; ) {
                                    ...
                                    k.positioned ? (f[u] = k.position.x, b[u] = k.position.y) : (f[u] = t.x + Math.cos(m) * v, b[u] = t.y + Math.sin(m) * v),
                                    x[u] = k.positioned,
                                    m += y
                                }
                                var C = Array(p);
                                ...
                                for (var T, w, I, P, B, L, E; u--; ) {
                                    ...
                                    P = 0;
                                    for (var D = p; D--; )
                                        u !== D && (B = f[D], L = b[D], E = 1 / a((T - B) * (T - B) + (w - L) * (w - L)), R[u][D] = [S[u][D] * (T - B - C[u][D] * (T - B) * E), S[u][D] * (w - L - C[u][D] * (w - L) * E)], R[D][u] = R[u][D], I += R[u][D][0], P += R[u][D][1]);
                                    A[u] = I,
                                    j[u] = P
                                }
                                for (var N = function (e) {
                                    ...
                                    D;
                                    for (u = p; u--; )
                                        e !== u && (P = f[u], B = b[u], L = I[u][0], E = I[u][1], D = 1 / a((g - P) * (g - P) + (d - B) * (d - B)), w = c[u] * (g - P - h[u] * (g - P) * D), T = c[u] * (d - B - h[u] * (d - B) * D), I[u] = [w, T], t += w, n += T, A[u] += w - L, j[u] += T - E);
                                        A[e] = t,
                                        j[e] = n
                            ...
                            value: function (e, t, n, r, a, l, s) {
                                t[e] = !0,
                                n[e] = r[e] = ++this._time;
                                for (var g = 0, i; g < l[e].length; g++)
                                    i = l[e][g], t[i] ? i !== a[e] && (r[e] = o(r[e], n[i])) : (a[i] = e, this._bridgeDfs(i, t, n, r, a, l, s), r[e] = o(r[e], r[i]), r[i] > n[e] && s.push([e, i]))
                            }
                        }
                    ], [{
                            ...
                            value: function (t) {
                                ...
                                i.fill(!1);
                                for (var a = 0; a < n; a++)
                                    i[a] || (i[a] = !0, r++, e._ccCountDfs(a, i, t));
                                return r
                            }
                        }, {
                            key: "_ccCountDfs",
                            value: function (t, n, i) {
                                for (var r = 0, a; r < i[t].length; r++)
                                    (a = i[t][r], a && !n[r] && t !== r) && (n[r] = !0, e._ccCountDfs(r, n, i))
                            }
                        }, {
                            key: "_ccGetDfs",
                            value: function (t, n, i, r) {
                                for (var a = 0, o; a < i[t].length; a++)
                                    (o = i[t][a], o && !n[a] && t !== a) && (n[a] = !0, r.push(a), e._ccGetDfs(a, n, i, r))
                            }
                        }
                    ]),
                e
    ...
    8: [function (e, t) {
            ...
            o = function () {
                ...
                return r(e, [{
                            ...
                            key: "setRightVector",
                            value: function (e, t) {
                                return this.from.x < this.to.x ? (this.to.x = e, this.to.y = t) : (this.from.x = e, this.from.y = t),
                                this
                            }
                        }, {
                            key: "setLeftVector",
                            value: function (e, t) {
                                return this.from.x < this.to.x ? (this.from.x = e, this.from.y = t) : (this.to.x = e, this.to.y = t),
                                this
                            }
                        }, {
                            key: "rotateToXAxis",
                            value: function () {
                                ...
                                return this.setRightVector(e.x + this.getLength(), e.y),
                                this
                            }
                        }, {
                            key: "rotate",
                            value: function (e) {
                                ...
                                return this.setRightVector(a, o),
                                this
                            }
                        }, {
                            key: "shortenFrom",
                            ...
                            key: "shortenRight",
                            value: function (e) {
                                return this.from.x < this.to.x ? this.shortenTo(e) : this.shortenFrom(e),
                                this
                            }
                        }, {
                            key: "shortenLeft",
                            value: function (e) {
                                return this.from.x < this.to.x ? this.shortenFrom(e) : this.shortenTo(e),
                                this
                            }
                        }, {
                            key: "shorten",
                    ...
                    var o = {
                        ...
                        class: function (e) {
                            ...
                            for (n = 0; n < e.parts.length; n++)
                                t += e.parts[n]instanceof Array ? r(e.parts[n][0]) + "-" + r(e.parts[n][1]) : r(e.parts[n]);
                            return "[" + (e.inverted ? "^" : "") + t + "]"
                        },
                        any: function () {
                    ...
                    parse: function (t, n) {
                        ...
                        function a(e) {
                            ...
                            for (n = rt[i], n = {
                                ...
                                10 === t.charCodeAt(i) ? (n.line++, n.column = 1) : n.column++, i++;
                            return rt[e] = n,
                            n
                        }
                        function o(e, t) {
                        ...
                        function s() {
                            ...
                            if (e = nt, t = nt, n = d(), n !== T) {
                                for (i = [], r = g(); r !== T; )
                                    i.push(r), r = g();
                                if (i !== T) {
                                    for (r = [], a = nt, o = u(), o === T && (o = null), o === T ? (nt = a, a = T) : (l = m(), l === T ? (nt = a, a = T) : (o = [o, l], a = o)); a !== T; )
                                        r.push(a), a = nt, o = u(), o === T && (o = null), o === T ? (nt = a, a = T) : (l = m(), l === T ? (nt = a, a = T) : (o = [o, l], a = o));
                                    if (r !== T) {
                                        for (a = [], o = g(); o !== T; )
                                            a.push(o), o = g();
                                        if (a === T)
                                            nt = t, t = T;
                                        else if (o = u(), o === T && (o = null), o === T)
                                            nt = t, t = T;
                        ...
                        function g() {
                            ...
                            return e = nt,
                            n = nt,
                            40 === t.charCodeAt(nt) ? (i = B, nt++) : (i = T, l(L)),
                            i === T ? (nt = n, n = T) : (r = u(), r === T && (r = null), r === T ? (nt = n, n = T) : (a = s(), a === T ? (nt = n, n = T) : (41 === t.charCodeAt(nt) ? (o = E, nt++) : (o = T, l(D)), o === T ? (nt = n, n = T) : (i = [i, r, a, o], n = i)))),
                            n !== T && (it = e, n = N(n)),
                            e = n,
                            e
                        }
                        ...
                        function u() {
                            ...
                            n;
                            return e = nt,
                            V.test(t.charAt(nt)) ? (n = t.charAt(nt), nt++) : (n = T, l(H)),
                            n !== T && (it = e, n = z(n)),
                            e = n,
                            e
                        }
                        ...
                        function c() {
                            ...
                            return e = nt,
                            n = nt,
                            66 === t.charCodeAt(nt) ? (i = K, nt++) : (i = T, l(Z)),
                            i === T ? (nt = n, n = T) : (114 === t.charCodeAt(nt) ? (r = $, nt++) : (r = T, l(Q)), r === T && (r = null), r === T ? (nt = n, n = T) : (i = [i, r], n = i)),
                            n === T && (n = nt, 67 === t.charCodeAt(nt) ? (i = J, nt++) : (i = T, l(ee)), i === T ? (nt = n, n = T) : (108 === t.charCodeAt(nt) ? (r = te, nt++) : (r = T, l(ne)), r === T && (r = null), r === T ? (nt = n, n = T) : (i = [i, r], n = i)), n === T && (ie.test(t.charAt(nt)) ? (n = t.charAt(nt), nt++) : (n = T, l(re)))),
                            n !== T && (it = e, n = ae(n)),
                            e = n,
                            e
                        }
                        function p() {
                            ...
                            n;
                            return e = nt,
                            oe.test(t.charAt(nt)) ? (n = t.charAt(nt), nt++) : (n = T, l(le)),
                            n !== T && (it = e, n = O(n)),
                            e = n,
                            e
                        }
                        function v() {
                            ...
                            n;
                            return e = nt,
                            42 === t.charCodeAt(nt) ? (n = se, nt++) : (n = T, l(ge)),
                            n !== T && (it = e, n = de(n)),
                            e = n,
                            e
                        }
                        function y() {
                            ...
                            return e = nt,
                            n = nt,
                            ue.test(t.charAt(nt)) ? (i = t.charAt(nt), nt++) : (i = T, l(he)),
                            i === T ? (nt = n, n = T) : (ce.test(t.charAt(nt)) ? (r = t.charAt(nt), nt++) : (r = T, l(pe)), r === T && (r = null), r === T ? (nt = n, n = T) : (i = [i, r], n = i)),
                            n !== T && (it = e, n = ve(n)),
                            e = n,
                            e
                        }
                        function m() {
                            ...
                            return e = nt,
                            n = nt,
                            37 === t.charCodeAt(nt) ? (i = ye, nt++) : (i = T, l(me)),
                            i === T ? (nt = n, n = T) : (fe.test(t.charAt(nt)) ? (r = t.charAt(nt), nt++) : (r = T, l(be)), r === T ? (nt = n, n = T) : (xe.test(t.charAt(nt)) ? (a = t.charAt(nt), nt++) : (a = T, l(ke)), a === T ? (nt = n, n = T) : (i = [i, r, a], n = i))),
                            n === T && (xe.test(t.charAt(nt)) ? (n = t.charAt(nt), nt++) : (n = T, l(ke))),
                            n !== T && (it = e, n = Ce(n)),
                            e = n,
                            e
                        }
                        function f() {
                            ...
                            return e = nt,
                            n = nt,
                            64 === t.charCodeAt(nt) ? (i = Se, nt++) : (i = T, l(Re)),
                        ...
                        function x() {
                            ...
                            return e = nt,
                            n = nt,
                            43 === t.charCodeAt(nt) ? (i = We, nt++) : (i = T, l(_e)),
                            i === T ? (nt = n, n = T) : (43 === t.charCodeAt(nt) ? (r = We, nt++) : (r = T, l(_e)), r === T && (r = nt, fe.test(t.charAt(nt)) ? (a = t.charAt(nt), nt++) : (a = T, l(be)), a === T ? (nt = r, r = T) : (xe.test(t.charAt(nt)) ? (o = t.charAt(nt), nt++) : (o = T, l(ke)), o === T && (o = null), o === T ? (nt = r, r = T) : (a = [a, o], r = a))), r === T && (r = null), r === T ? (nt = n, n = T) : (i = [i, r], n = i)),
                            n !== T && (it = e, n = Me(n)),
                            e = n,
                            e
                        }
                        function k() {
                            ...
                            return e = nt,
                            n = nt,
                            45 === t.charCodeAt(nt) ? (i = qe, nt++) : (i = T, l(Ue)),
                            i === T ? (nt = n, n = T) : (45 === t.charCodeAt(nt) ? (r = qe, nt++) : (r = T, l(Ue)), r === T && (r = nt, fe.test(t.charAt(nt)) ? (a = t.charAt(nt), nt++) : (a = T, l(be)), a === T ? (nt = r, r = T) : (xe.test(t.charAt(nt)) ? (o = t.charAt(nt), nt++) : (o = T, l(ke)), o === T && (o = null), o === T ? (nt = r, r = T) : (a = [a, o], r = a))), r === T && (r = null), r === T ? (nt = n, n = T) : (i = [i, r], n = i)),
                            n !== T && (it = e, n = Ge(n)),
                            e = n,
                            e
                        }
                        function C() {
                            ...
                            return e = nt,
                            n = nt,
                            72 === t.charCodeAt(nt) ? (i = Xe, nt++) : (i = T, l(Ye)),
                            i === T ? (nt = n, n = T) : (xe.test(t.charAt(nt)) ? (r = t.charAt(nt), nt++) : (r = T, l(ke)), r === T && (r = null), r === T ? (nt = n, n = T) : (i = [i, r], n = i)),
                            n !== T && (it = e, n = Ke(n)),
                            e = n,
                            e
                        }
                        function S() {
                            ...
                            if (e = nt, n = nt, 58 === t.charCodeAt(nt) ? (i = Ze, nt++) : (i = T, l($e)), i !== T) {
                                if (r = nt, fe.test(t.charAt(nt)) ? (a = t.charAt(nt), nt++) : (a = T, l(be)), a !== T) {
                                    for (o = [], xe.test(t.charAt(nt)) ? (s = t.charAt(nt), nt++) : (s = T, l(ke)); s !== T; )
                                        o.push(s), xe.test(t.charAt(nt)) ? (s = t.charAt(nt), nt++) : (s = T, l(ke));
                                    o === T ? (nt = r, r = T) : (a = [a, o], r = a)
                                } else
                                    nt = r, r = T;
                                r === T && (Qe.test(t.charAt(nt)) ? (r = t.charAt(nt), nt++) : (r = T, l(Je))),
                                r === T ? (nt = n, n = T) : (i = [i, r], n = i)
                            } else
                                nt = n, n = T;
                            return n !== T && (it = e, n = et(n)),
                            e = n,
                            e
                        }
                        function R() {
                            ...
                            return e = nt,
                            n = nt,
                            fe.test(t.charAt(nt)) ? (i = t.charAt(nt), nt++) : (i = T, l(be)),
                            i === T ? (nt = n, n = T) : (xe.test(t.charAt(nt)) ? (r = t.charAt(nt), nt++) : (r = T, l(ke)), r === T && (r = null), r === T ? (nt = n, n = T) : (xe.test(t.charAt(nt)) ? (a = t.charAt(nt), nt++) : (a = T, l(ke)), a === T && (a = null), a === T ? (nt = n, n = T) : (i = [i, r, a], n = i))),
                            n !== T && (it = e, n = tt(n)),
                            e = n,
                            e
                        }
                        ...
                        I = s,
                        P = function (e) {
                            for (var t = [], n = [], r = 0; r < e[1].length; r++)
                                t.push(e[1][r]);
                            for (var r = 0, i; r < e[2].length; r++)
                                i = e[2][r][0] ? e[2][r][0] : "-", n.push({
                                    bond: i,
                                    id: e[2][r][1]
                                });
                            for (var r = 0; r < e[3].length; r++)
                                t.push(e[3][r]);
                            for (var r = 0; r < e[6].length; r++)
                                t.push(e[6][r]);
                            return {
                                atom: e[0],
            ...
            s = function () {
                ...
                return i(e, [{
                            ...
                            value: function (e, t, n, i) {
                                ...
                                for (var r = n, a = 0, o; null != r && 100 > a; )
                                    o = r, t(o), r = e[r].getNextInRing(e, this.id, i), i = o, r == n && (r = null), a++
                            }
                        }, {
                            key: "getOrderedNeighbours",
                            value: function (e) {
                                for (var t = Array(this.neighbours.length), n = 0, i; n < this.neighbours.length; n++)
                                    i = l.getVertices(e, this.id, this.neighbours[n]), t[n] = {
                                        n: i.length,
                            ...
                            value: function (e) {
                                for (var t = 0, n = 0, i; n < this.members.length; n++)
                                    i = e[this.members[n]].value, ("=" === i.bondType || "=" === i.branchBond) && t++;
                                return t
                            }
                        }, {
                            key: "contains",
    ...
    12: [function (e, t) {
            ...
            l = function () {
                function e(t, r) {
                    ...
                    this.secondRingId = r.id,
                    this.vertices = new Set;
                    for (var a = 0, o; a < t.members.length; a++) {
                        o = t.members[a];
                        for (var l = 0, n; l < r.members.length; l++)
                            n = r.members[l], o === n && this.addVertex(o)
                    }
                }
                return r(e, [{
                            key: "addVertex",
                            ...
                            value: function (e) {
                                ...
                                try {
                                    for (var r = this.vertices[Symbol.iterator](), a, o; !(t = (a = r.next()).done); t = !0)
                                        if (o = a.value, 2 < e[o].value.rings.length)
                                            return !0
                                } catch (e) {
                                    n = !0,
                                    i = e
                            ...
                            value: function (e, t, n, r) {
                                for (var a = null, o = 0; o < e.length; o++)
                                    if (a = e[o], a.firstRingId === n && a.secondRingId === r || a.firstRingId === r && a.secondRingId === n)
                                        return a.isBridge(t);
                                return !1
                            }
                        }, {
                            key: "getNeighbours",
                            value: function (e, t) {
                                for (var n = [], r = 0, i; r < e.length; r++)
                                    i = e[r], i.firstRingId === t ? n.push(i.secondRingId) : i.secondRingId === t && n.push(i.firstRingId);
                                return n
                            }
                        }, {
                            key: "getVertices",
                            value: function (e, t, r) {
                                for (var a = 0, i; a < e.length; a++)
                                    if (i = e[a], i.firstRingId === t && i.secondRingId === r || i.firstRingId === r && i.secondRingId === t)
                                        return [].concat(n(i.vertices))
                            }
                        }
                    ]),
                e
                ...
                return r(e, null, [{
                            ...
                            value: function (t) {
                                ...
                                for (var o = a.getConnectedComponents(r), l = [], s = 0; s < o.length; s++) {
                                    for (var i = o[s], g = t.getSubgraphAdjacencyMatrix([].concat(n(i))), u = new Uint16Array(g.length), h = new Uint16Array(g.length), p = 0; p < g.length; p++) {
                                        h[p] = 0,
                                        u[p] = 0;
                                        for (var v = 0; v < g[p].length; v++)
                                            u[p] += g[p][v]
                                    }
                                    for (var y = 0, p = 0; p < g.length; p++)
                                        for (var v = p + 1; v < g.length; v++)
                                            y += g[p][v];
                                    for (var m = y - g.length + 1, f = !0, p = 0; p < u.length; p++)
                                        3 !== u[p] && (f = !1);
                                    ...
                                    for (var b = e.getPathIncludedDistanceMatrices(g), x = b.d, d = b.pe, k = b.pe_prime, C = e.getRingCandidates(x, d, k), c = e.getSSSR(C, x, g, d, k, u, h, m), p = 0; p < c.length; p++) {
                                        ...
                                        T = void 0;
                                        try {
                                            for (var w = c[p][Symbol.iterator](), I, P; !(A = (I = w.next()).done); A = !0)
                                                P = I.value, S[R++] = i[P]
                                        } catch (e) {
                                            j = !0,
                                            T = e
                            ...
                            value: function (e) {
                                for (var t = e.length, r = Array(t), a = Array(t), o = Array(t), s = 0, l = 0, g = 0, n = t; n--; ) {
                                    ...
                                    o[n] = Array(t);
                                    for (var i = t; i--; )
                                        r[n][i] = n === i || 1 === e[n][i] ? e[n][i] : Number.POSITIVE_INFINITY, a[n][i] = 1 === r[n][i] ? [[[n, i]]] : [], o[n][i] = []
                                }
                                for (var u = t, i; u--; )
                                    for (n = t; n--; )
                                        for (i = t; i--; ) {
                                                ...
                                                if (h === c + 1)
                                                    for (o[n][i] = [a[n][i].length], s = a[n][i].length; s--; )
                                                        for (o[n][i][s] = [a[n][i][s].length], l = a[n][i][s].length; l--; )
                                                            for (o[n][i][s][l] = [a[n][i][s][l].length], g = a[n][i][s][l].length; g--; )
                                                                o[n][i][s][l][g] = [a[n][i][s][l][0], a[n][i][s][l][1]];
                                                else
                                                    o[n][i] = [];
                                                for (r[n][i] = c, a[n][i] = [[]], s = a[n][u][0].length; s--; )
                                                    a[n][i][0].push(a[n][u][0][s]);
                                                for (s = a[u][i][0].length; s--; )
                                                    a[n][i][0].push(a[u][i][0][s])
                                            } else if (h === c) {
                                                if (a[n][u].length && a[u][i].length) {
                                                    var s;
                                                    if (a[n][i].length) {
                                                        var p = [];
                                                        for (s = a[n][u][0].length; s--; )
                                                            p.push(a[n][u][0][s]);
                                                        for (s = a[u][i][0].length; s--; )
                                                            p.push(a[u][i][0][s]);
                                                        a[n][i].push(p)
                            ...
                            value: function (e, t, n) {
                                for (var r = e.length, a = [], o = 0, l = 0; l < r; l++)
                                    for (var i = 0; i < r; i++)
                                        if (0 === e[l][i] || 1 === t[l][i].length && 0 === n[l][i])
                                            continue;
                                        else
                                            o = 0 === n[l][i].length ? 2 * e[l][i] : 2 * (e[l][i] + 0.5), o != Infinity && a.push([o, t[l][i], n[l][i]]);
                                ...
                                for (var d = [], u = [], h = 0; h < t.length; h++)
                                    if (0 != t[h][0] % 2)
                                        for (var i = 0, c; i < t[h][2].length; i++) {
                                            ...
                                            if (e.getBondCount(v, r) !== v.size || e.pathSetsContain(d, v, c, u, l, s) || (d.push(v), u = u.concat(c)), d.length > g)
                                                return d
                                        }
                                    else
                                        for (var y = 0, m; y < t[h][1].length - 1; y++) {
                                            ...
                                            for (var p = 0; p < m.length; p++)
                                                m[p][0].constructor === Array && (m[p] = m[p][0]);
                                            var f = e.bondsToAtoms(m);
                                            if (e.getBondCount(f, r) !== f.size || e.pathSetsContain(d, f, m, u, l, s) || (d.push(f), u = u.concat(m)), d.length > g)
                                                return d
                                        }
                                return d
                            }
                            ...
                            value: function (e, t) {
                                ...
                                try {
                                    for (var o = e[Symbol.iterator](), l; !(i = (l = o.next()).done); i = !0) {
                                        ...
                                        u = void 0;
                                        try {
                                            for (var h = e[Symbol.iterator](), c, p; !(g = (c = h.next()).done); g = !0)
                            ...
                            value: function (t, n, r, a, o, l) {
                                ...
                                for (s = r.length; s--; )
                                    for (var d = a.length; d--; )
                                        (r[s][0] === a[d][0] && r[s][1] === a[d][1] || r[s][1] === a[d][0] && r[s][0] === a[d][1]) && i++, i === r.length && (g = !0);
                                var u = !1;
                                if (g) {
                                    var h = !0,
                                    c = !1,
                                ...
                                x;
                                try {
                                    for (var k = n[Symbol.iterator](), C, S; !(f = (C = k.next()).done); f = !0)
                                        S = C.value, l[S]++
                                } catch (e) {
                                    b = !0,
                                    x = e
    ...
    14: [function (e, t) {
            ...
            l = function () {
                function e(t, i) {
                    n(this, e),
                    0 == arguments.length ? (this.x = 0, this.y = 0) : 1 == arguments.length ? (this.x = t.x, this.y = t.y) : (this.x = t, this.y = i)
                }
                var t = Math.acos;
                return o(e, [{
                            key: "clone",
                            ...
                            value: function (t) {
                                ...
                                a = r(t),
                                o = i(t);
                                return n.x = this.x * a - this.y * o,
                                n.y = this.x * o + this.y * a,
                                this.x = n.x,
                                this.y = n.y,
                                this
                            }
                            ...
                            value: function (t, n) {
                                ...
                                a = e.subtract(t, n),
                                o = e.angle(a, r);
                                return this.rotateAround(o + i, n),
                                this
                            }
                        }, {
                            key: "rotateAwayFrom",
                            ...
                            key: "isInPolygon",
                            value: function (e) {
                                for (var t = !1, n = 0, i = e.length - 1; n < e.length; i = n++)
                                    e[n].y > this.y != e[i].y > this.y && this.x < (e[i].x - e[n].x) * (this.y - e[n].y) / (e[i].y - e[n].y) + e[n].x && (t = !t);
                                return t
                            }
                        }, {
                            key: "length",
                            ...
                            value: function (t) {
                                for (var n = new e(0, 0), r = 0, i; r < t.length; r++)
                                    i = t[r], n.add(i);
                                return n.normalize()
                            }
                        }
    ...
    15: [function (e, t) {
            ...
            g = function () {
                function e(t) {
                    ...
                    this.id = null,
                    this.value = t,
                    this.position = new l(i ? i : 0, r ? r : 0),
                    this.previousPosition = new l(0, 0),
                ...
                return i(e, [{
                            ...
                            value: function (e, t) {
                                if (this.children.push(e), this.value.bracket) {
                                    ...
                                    1 === this.value.bracket.hcount && 1 === t && (3 > this.neighbours.length ? n = 2 : n = 3),
                                    null === this.value.bracket.hcount && 0 === t && (n = 1),
                                    null === this.value.bracket.hcount && 1 === t && (3 > this.neighbours.length ? n = 1 : n = 2),
                            ...
                            value: function () {
                                ...
                                return t.id = this.id,
                                t.previousPosition = new l(this.previousPosition.x, this.previousPosition.y),
                                t.parentVertexId = this.parentVertexId,
                                t.children = o.clone(this.children),
                                t.spanningTreeChildren = o.clone(this.spanningTreeChildren),
                                t.edges = o.clone(this.edges),
                                t.positioned = this.positioned,
                                t.angle = this.angle,
                            ...
                            value: function () {
                                ...
                                n = null;
                                return n = e ? l.subtract(this.position, e) : l.subtract(this.position, this.previousPosition),
                                t ? a.toDeg(n.angle()) : n.angle()
                            }
                        }, {
                            key: "getTextDirection",
                            value: function (e) {
                                for (var t = this.getDrawnNeighbours(e), n = [], o = 0; o < t.length; o++)
                                    n.push(this.getAngle(e[t[o]].position));
                                var i = a.meanAngle(n),
                                l = Math.PI / 2;
                                return i = r(r(i / l) * l),
                                2 === i ? "down" : -2 === i ? "up" : 0 === i || -0 === i ? "right" : 3 === i || -3 === i ? "left" : "down"
                            }
                        }, {
                            key: "getNeighbours",
                            value: function () {
                            ...
                            value: function () {
                                for (var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null, t = [], n = 0; n < this.spanningTreeChildren.length; n++)
                                    (void 0 === e || e != this.spanningTreeChildren[n]) && t.push(this.spanningTreeChildren[n]);
                                return null != this.parentVertexId && (void 0 === e || e != this.parentVertexId) && t.push(this.parentVertexId),
                                t
                            }
                        }, {
                            key: "getNextInRing",
